"use strict";var a=function(e,r){return function(){try{return r||e((r={exports:{}}).exports,r),r.exports}catch(t){throw (r=0, t)}};};var q=a(function(R,s){
var i=require('@stdlib/math-base-assert-is-nan/dist'),f=require('@stdlib/math-base-special-tan/dist'),N=require('@stdlib/constants-float64-pi/dist');function y(e,r,t){return i(e)||i(r)||i(t)||t<=0||e<0||e>1?NaN:r+t*f(N*(e-.5))}s.exports=y
